...
def acquire_bot_turn_lock(redis_client: Redis, bot_id: str, hand_id: str, turn_id: str) -> bool:
    return acquire_turn_lock(redis_client, turn_lock_key(bot_id, hand_id, turn_id), get_settings().bot_lock_ttl_seconds)
